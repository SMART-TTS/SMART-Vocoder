...
def parse_args():
    ...
    parser.add_argument('--synth_interval', type=int, default=1, help='Sampling interval during training')
    ...
    parser.add_argument('--n_layers', type=list, default=[10,10,8,8], help='Number of layers in WaveNet')
