...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='datasets/preprocessed_hop_300', help='Dataset path')
    ...
    parser.add_argument('--bsz', '-b', type=int, default=16, help='Batch size')
    ...
    parser.add_argument('--sqz_scale', type=int, default=5, help='Squeeze scale between Equal Resolution blocks (sqz_scale shuold be 4)')
    parser.add_argument('--n_ER_blocks', type=int, default=3, help='Number of Equal Resolution blocks')
    parser.add_argument('--n_flow_blocks', type=int, default=5, help='Number of flow blocks in Equal Resolution block')
    parser.add_argument('--n_layers', type=list, default=[8, 8, 8], help='Number of layers in WaveNet')
    parser.add_argument('--di_cycle', type=list, default=[8, 6, 4], help='Dilation cycle in WaveNet')
