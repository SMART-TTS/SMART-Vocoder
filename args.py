...
def parse_args():
    ...
    parser.add_argument('--synth_interval', type=int, default=100, help='Sampling interval during training')
    ...
    parser.add_argument('--n_ER_blocks', type=int, default=1, help='Number of Equal Resolution blocks')
    parser.add_argument('--n_flow_blocks', type=int, default=4, help='Number of flow blocks in Equal Resolution block')
    parser.add_argument('--n_layers', type=list, default=[8], help='Number of layers in WaveNet')
